...
from eegnb import generate_save_fn # GIORGIO
...
def present(duration=120, eeg=None, save_fn=None):
    ...
    # Generate stimuli
    am1 = generate_am_waveform(1000, 40.018, secs=soa, sample_rate=44100)
    am2 = generate_am_waveform(1000, 40.018, secs=soa, sample_rate=44100)
    ...
    for ii, trial in trials.iterrows():
        ...
        ind = 0
        aud1.play() # in this way only aud 1 is played. set aud[ind] to actually randomize
